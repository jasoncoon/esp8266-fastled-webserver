...
#if !defined(ESP8266_FASTLED_WEBSERVER_PRODUCT_HEXRINGS228_H)
#define ESP8266_FASTLED_WEBSERVER_PRODUCT_HEXRINGS228_H
   ...
   #define MAX_MILLI_AMPS_PER_PIXEL      36   // IMPORTANT: set to larger value if necessary
#endif
   ...
   #define NAME_PREFIX                   "HexRings228-"
#endif
#if !defined(PRODUCT_FRIENDLY_NAME)
   #define PRODUCT_FRIENDLY_NAME         "HexRings228"
#endif
...
#endif // ESP8266_FASTLED_WEBSERVER_PRODUCT_HEXRINGS228_H
